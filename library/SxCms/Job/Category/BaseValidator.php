...
/**
 * @category   SxCms
 * @package    SxCms_Job_Category_BaseValidator
 * @copyright  Copyright (c) 2009-2010 Sanmax Consultancy BVBA. (http://www.sanmax.be)
 */
class SxCms_Job_Category_BaseValidator
{
    /**
     * Category object
     *
     * @var SxCms_Job_Category
     */
    protected $category;
     ...
     * @return boolean
     */
    public function validate(SxCms_Job_Category $category)
    {
        ...
        if (!Sanmax_MessageStack::getInstance('SxCms_Job_Category')->getNamespaceMessages()) {
            return true;
        }
