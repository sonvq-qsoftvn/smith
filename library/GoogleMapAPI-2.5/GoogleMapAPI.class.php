...
/* $Id: GoogleMapAPI.class.php,v 1.1.1.1 2008/10/27 02:19:34 huytran Exp $ */
...
class GoogleMapAPI {
    ...
    var $driving_dir_text = array(
            'dir_to' => 'Vertrek: (bv. Europalaan 1, 3600, Genk)',
            'to_button_value' => 'Bereken route',
            'to_button_type' => 'submit',
            'dir_from' => 'Aankomst: (bv. Europalaan 1, 3600, Genk)',
            'from_button_value' => 'Bereken route',
            'from_button_type' => 'submit',
            'dir_text' => 'Route: ',
            'dir_tohere' => 'Naar hier',
            'dir_fromhere' => 'Van hier'
            );             
