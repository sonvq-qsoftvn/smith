<?php
	...
	$mcFileManagerConfig['filesystem.path'] = dirname(__FILE__) . '/../../../../files'; // absolute or relative from this script path.
	$mcFileManagerConfig['filesystem.rootpath'] = dirname(__FILE__) . '/../../../../files'; // absolute or relative from this script path.
