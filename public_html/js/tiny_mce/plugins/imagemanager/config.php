<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = dirname(__FILE__) . '/../../../../files'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,wmv,mov,flv";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,wmv,mov,flv";
