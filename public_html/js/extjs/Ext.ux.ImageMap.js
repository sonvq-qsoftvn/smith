...
Ext.ux.ImageMapPanel = Ext.extend(Ext.Panel, {
	...
	*/
	...
	getAreaHtml : function(area){
		...
		if (area.ahref && area.ahref!='') html += ' href="' + area.ahref + '" onmouseover="groundplan.stopLoop(\'' + area.ahref + '\',\'' + type + '\');" onmouseout="groundplan.goLoop(\'' + area.ahref + '\',\'' + type + '\');" onclick="return false;"' ;
		/* STOP EDIT SANMAX */
